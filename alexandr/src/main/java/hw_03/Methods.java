...
public class Methods {
    public static void main(String[] args) {
        ...
        positiveDevide(); // 8. Положительные делители введенного натурального числа.
    }
    ...
    static void positiveDevide () {
        print("Введите число для определения всех его положительных делителей: ");
        int usersDigital = scan();
